...
import { ActiveFilter, Column, FilterForm, FilterOption, SelectFilterParams } from '../../../models';
import { valueValidator } from 'src/app/core/util';
...
export class FilterSelectFormComponent<TValue = any> implements FilterForm, OnInit {
  ...
  constructor(fb: FormBuilder) {
    this.form = fb.group({
      option: (this.optionCtrl = fb.control(null, valueValidator)),
    });
  }
